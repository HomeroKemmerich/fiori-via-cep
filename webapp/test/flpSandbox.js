		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Via CEP",
									"targetURL": "#brcomstarafioriviacep-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomstarafioriviacep-display": {
								"semanticObject": "brcomstarafioriviacep",
								"action": "display",
								"description": "Via CEP",
								"title": "Via CEP",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.stara.fioriviacep",
									"url": sap.ui.require.toUrl("br/com/stara/fioriviacep")
								}
							}
						}
					}
